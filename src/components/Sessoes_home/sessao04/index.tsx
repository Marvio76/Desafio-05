        ...
        <div className={style.container}>
            ...
            <div className={style.cardContainer}>
                <div className={style.card}>
                    <img className={style.icon} src={amor} />
                ...
                <div className={style.card}>
                    <img className={style.icon} src={atendimentoDeQualidade} />
                ...
                <div className={style.card}>
                    <img className={style.icon} src={agilidadeNasConsultas} />
                    <div className={style.cardContent}>
                ...
                <div className={style.card}>
                    <img className={style.icon} src={priorizamosAEquidade} />
                    <div className={style.cardContent}>
                ...
                <div className={style.card}>
                    <img className={style.icon} src={profissionaisQualidifcados} />
                    <div className={style.cardContent}>
                ...
                <div className={style.card}>
                    <img className={style.icon} src={cuidadoDeVoce} />
                    <div className={style.cardContent}>
